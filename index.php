...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9">Asistencia Guardería Dabaleg</div>
        ...
        <table class="table table-striped table-bordered" id="student_table">
          <thead>
            <tr>
              ...
              <th>ID</th>
              <th>Curso</th>
              <th>Percentaje de asistencia</th>
              <th>Reporte</th>
            </tr>
          </thead>
          <tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="create_report" id="create_report" class="btn btn-success btn-sm">Hacer reporte</button>
